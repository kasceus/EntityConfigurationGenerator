using EntityConfigurationGenerator.Menus.RightClickMenu;
...
namespace EntityConfigurationGenerator
{
    ...
    internal sealed class GenerateSingleConfigurationCommand
    {
        ...
        private GenerateSingleConfigurationCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var menuCommandID = new CommandID(RightClickConstants._CommandSet, RightClickConstants._GenerateSingleConfigurationCommandId);
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            string newClassName = generateAsPartial
                                ? className
